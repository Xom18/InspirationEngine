...
bool StrUTF8::IsValidStartByte(unsigned char c)
{
...
size_t StrUTF8::GetUTF8ByteLength(unsigned char c)
{
...
void StrUTF8::pop_back(std::string& inputStr)
{
	if (inputStr.empty())
		return;
...
void StrUTF8::pop_front(std::string& inputStr)
{
	if (inputStr.empty())
		return;
...
size_t StrUTF8::getMemoryPoint(std::string& str, size_t point)
{
	if (point == 0)
		return 0;
...
void StrUTF8::removeToFront(std::string& str, size_t point, size_t count)
{
...
void StrUTF8::removeToBack(std::string& str, size_t point, size_t count)
{
